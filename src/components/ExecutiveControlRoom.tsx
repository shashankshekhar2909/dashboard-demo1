  ...
  return (
    <Box className="ecr-root" sx={{ display: 'flex', minHeight: '100vh', bgcolor: '#EEF2F7' }}>
      ...
      <Box className="ecr-main-area" sx={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        >
          {/* Page header */}
          <Box className="ecr-page-header" sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: '24px' }}>
          ...
          {/* Secondary KPI row */}
          <Box className="ecr-secondary-kpi-row" sx={{ display: 'flex', gap: '16px', mb: '24px' }}>
